<article class="post card bg-white shadow-sm border-0 <?php if (get_option('lyrargon_enable_into_article_animation') == 'true'){echo 'post-preview';} ?> post-preview-layout-3" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<?php
