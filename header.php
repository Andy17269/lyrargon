...
<head>
	...
	<?php
		...
		wp_enqueue_script("argon_js_merged", $GLOBALS['assets_path'] . "/assets/argon_js_merged.js", array('jquery'), $GLOBALS['theme_version']);
...
<?php } ?>
<?php 
$card_blur = get_option('argon_card_blur');
