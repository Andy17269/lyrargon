...
<head>
	...
	<link href="<?php bloginfo('template_url'); ?>/assets/vendor/fontawesome-free-7.3.0-web/css/all.min.css" rel="stylesheet">
	<link href="<?php bloginfo('template_url'); ?>/assets/vendor/fontawesome-free-7.3.0-web/css/v4-shims.min.css" rel="stylesheet">
