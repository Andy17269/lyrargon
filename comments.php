			...
			<div class="row hide-on-comment-editing" style="margin-bottom: -10px;">
				<div class="<?php echo $col1_class;?>">
					<div class="form-group mb-4 position-relative">
						...
						<input id="post_comment_name" class="form-control form-control-alternative" style="padding-left: 38px;" placeholder="<?php _e('昵称', 'argon');?>" type="text" name="author" value="<?php if (is_user_logged_in()) {echo (wp_get_current_user() -> user_login);} else {echo htmlspecialchars($current_commenter['comment_author']);} ?>">
					</div>
				</div>
				...
				<div class="<?php echo $col3_class;?>">
					<div class="form-group mb-4 position-relative post-comment-captcha-container" captcha="<?php echo get_comment_captcha(get_comment_captcha_seed());?>">
						...
						<input id="post_comment_captcha" class="form-control form-control-alternative" style="padding-left: 38px;" placeholder="<?php _e('验证码', 'argon');?>" type="text" <?php if (current_user_can('level_7')) {echo('value="' . get_comment_captcha_answer(get_comment_captcha_seed()) . '" disabled');}?>>
						<style>
			...
			<div class="row hide-on-comment-editing" id="post_comment_extra_input" style="display: none";>
				<div class="col-md-12" style="margin-bottom: -10px;">
					<div class="form-group mb-4 position-relative post-comment-link-container">
						...
						<input id="post_comment_link" class="form-control form-control-alternative" style="padding-left: 38px;" placeholder="<?php _e('网站', 'argon'); ?>" type="text" name="url" value="<?php echo htmlspecialchars($current_commenter['comment_author_url']); ?>">
					</div>
				</div>
			</div>
